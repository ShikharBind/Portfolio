...
export default [
  ...
  // new ProjectData("project-7", "Shaders", "img/projects/project-6-icon.png", "img/projects/project-6-icon.png",
  ...
  //           This is made to learn the intricacies behind game engines.
  //         </div>
  ...
  //         </div>-->`, "#1ca1e2"),
    ...
    new ProjectData("project-7", "Scotch Game Engine", "img/projects/project-6-icon.png", "img/projects/project-6-icon.png",
      "A 2D game engine developed in C++.", `
            <div class="paragraph">
              <strong>Scotch</strong> is a 2D game engine using <strong>C++</strong> on which one can make a 2D interactive software.
              This is made to learn the intricacies behind game engines.
    ...
    new ProjectData("project-8", "Visual Accessibility Toolkit", "img/projects/VAToolkit/icon.png", "img/projects/VAToolkit/icon.png",
      "A unity tool aimed at enhancing the experience of individals with colour vision deficiencies.", `
        <div class="paragraph">
    ...
    new ProjectData("project-6", "IITG OLX", "img/projects/olx/homess.png", "img/projects/olx/homess.png",
              "An e-commerce website similar to OLX made using Django.", `
            <div class="paragraph">
              <strong>IITG OLX</strong> is an e-commerce website similar to OLX where one can sell or buy products using Django framework.
                  ...
                  <div class="paragraph">
                    Main features :
                    <ul>
                    <li>Implemented user registration, login, product listing, and profile management functionalities.</li>
                    ...
                    <li>Integrated Microsoft's OAauth for user authentication.</li>
                    </ul>
                </div>
        
                <div class="paragraph">
                  <div class="notice">
                  Website is live <a href="http://54.199.191.180/" target="_blank">here</a>.
                    Source code available on <a href="https://github.com/ShikharBind/IITG-OLX" target="_blank">GitHub</a>.
                  </div>
                </div>
        
                <div class="paragraph center">
                  <img class="pc-screenshot" src="img/projects/olx/homess.png" alt="OLX Clone Screenshot" />

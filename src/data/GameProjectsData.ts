...
export default [
    ...
    `
    <div class="paragraph">
     <strong>Wickson - the Igniter</strong> is a <em>2D puzzle platformer</em> game made in Unity for IGDC gamedev challenge of Inter IIT 12.0.
    </div>
    ...
    <div class="paragraph">
        Role : Game Director <br />
        <br />
        Contribution :
        <ul>
            <li>
            Supervised a <b>10</b>-member team, shaping project, and ensuring efficient collaboration among designers, artists and programmers.
            </li>
            <li>
            Programmed player movement, fire spread mechanism, game manager, and user interface using <b>C#</b>.
            </li>
        </ul>
    </div>
    ...
    <div class="paragraph">
        <div class="notice">
        Windows build available on <a href="https://gdesiitg.itch.io/wickson-the-igniter" target="_blank">itch.io</a>.
        </div>
    </div>
    ...
    new ProjectData("project-2", "Chiranjeevi", "img/projects/Chiranjeevi/n2y443.png", "img/projects/Chiranjeevi/Ch0.gif",
        "A 3D roguelike role playing game based on Indian mythology developed using Unity.", `
    <div class="paragraph">
    ...
    `, "#5a78af"),
    new ProjectData("project-3", "Angioplasty VR Simulator", "img/projects/Angioplasty/angioplasty-icon.jpeg", "img/projects/Angioplasty/Angioplasty1.gif",
        "A VR simulation to practice Angioplasty heart surgery made using Unity and SteamVR.", `
    <div class="paragraph">
    ...
    <div class="paragraph">
        ...
        Source code is available on <a href="https://github.com/ShikharBind/Angioplasty-VR-Simulator" target="_blank">GitHub</a>.
        </div>
    </div>
    ...
    `, "#383838"),
    new ProjectData("project-4", "Devour!!", "img/projects/Devour/icon.png", "img/projects/Devour/Devour0.gif",
        "A 2D tower defense type game developed using Unity.", `
    <div class="paragraph">
    ...
    `, "#e80fb7"),
    // new ProjectData("project-5", "Chess 2D", "img/projects/project-5-icon.png", "img/projects/project-5-icon.png",
    ...
    // </div>`, "#e48246"),
    // new ProjectData("project-06", "Ludo", "img/projects/Ludo/ludo-icon.jpg", "img/projects/Ludo/ludo-icon.jpg",
    //     "A virtual recreation of IITG campus developed using Unity.", `
    // <div class="paragraph">
